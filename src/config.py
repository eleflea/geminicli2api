...
CLI_VERSION = os.getenv("GEMINI_CLI_VERSION", "0.19.4")  # Match current gemini-cli version

# OAuth Configuration
CLIENT_ID = "1234567890-abcdefghijkelmmmd.apps.googleusercontent.com"
CLIENT_SECRET = "GOCSPX-xxxxxx-xxxxxx-xxxxxxxxxxxxxX"
SCOPES = [
